...
command = "\x0a\x01\x02\x00\x02\x00"
send(command)
...
# SEND Conn response - success (SCID 0x0040 DCID 0x0040)
command = "\x03\x02\x08\x00\x40\x00\x40\x00\x00\x00\x00"
send(command)

# SEND Configure request (DCID 0x0040)
command = "\x04\x02\x04\x00\x40\x00\x00\x00"
send(command)
...
# SENT Configure response success (SCID 0x0040)
command = "\x05\x03\x0a\x00\x40\x00\x00\x00\x00\x00\x01\x02\x20\x03"
send(command)
...
# SENT Conn response pending (SCID 0x0041)
command = "\x03\x04\x08\x00\x41\x00\x41\x00\x01\x00\x02\x00"
send(command)

# SENT Conn response success (SCID 0x0041, DCID 0x0041)
command = "\x03\x04\x08\x00\x41\x00\x41\x00\x00\x00\x00\x00"
send(command)

# SENT Configure request (DCID 0x0041)
command = "\x04\x03\x04\x00\x41\x00\x00\x00"
send(command)
...
# SENT Configure response success (SCID 0x0041)
command = "\x05\x05\x0a\x00\x41\x00\x00\x00\x00\x00\x01\x02\x20\x03"
send(command)
